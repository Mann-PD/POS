...
import '../controllers/employee_ui_controller.dart';
import 'employee_form_screen.dart';

/// Employee List Screen - Admin view of all employees
/// Allows viewing, adding, editing, and activating/deactivating employees
...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
  final EmployeeUiController _uiController = Get.put(EmployeeUiController());
  String? _shopId;
                    ...
                    filteredEmployees = filteredEmployees
                        .where((employee) =>
                            ...
                            employee.email
                                ...
                                .contains(_uiController.searchQuery.value.toLowerCase()) ||
                            employee.phone
                                .contains(_uiController.searchQuery.value))
                        .toList();
                  }
